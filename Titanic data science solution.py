...
# cleaning and extracting name column
for dataset in combine:
    dataset['Title'] = dataset.Name.str.extract(' ([A-Za-z]+)\.', expand=False)

pd.crosstab(train_df['Title'], train_df['Sex'])

# further cleaning title column
for dataset in combine:
...
#converting categorical title into ordinal
...
# replacing null age values with median in age and pclass group
...
# replacing age with ordinals based
for dataset in combine:    
...
# converting parch and sibsp features into single feature
for dataset in combine:
...
# converting embarked into numeric features
for dataset in combine:
...
# converting fare feature to ordinal values
for dataset in combine:
...
# logistic regression coefficients for all features
